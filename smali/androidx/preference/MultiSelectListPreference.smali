...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, Landroidx/preference/MultiSelectListPreference;->O2:Ljava/util/Set;
    ...
    iput-object p2, p0, Landroidx/preference/MultiSelectListPreference;->M2:[Ljava/lang/CharSequence;
...
# virtual methods
.method public A9(Ljava/util/Set;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Landroidx/preference/MultiSelectListPreference;->O2:Ljava/util/Set;
    ...
    invoke-virtual {p0, p1}, Landroidx/preference/Preference;->C5(Ljava/util/Set;)Z
...
.method protected D4(Landroid/os/Parcelable;)V
    ...
    iget-object p1, p1, Landroidx/preference/MultiSelectListPreference$SavedState;->T1:Ljava/util/Set;

    invoke-virtual {p0, p1}, Landroidx/preference/MultiSelectListPreference;->A9(Ljava/util/Set;)V
...
.method protected I4()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0}, Landroidx/preference/MultiSelectListPreference;->v9()Ljava/util/Set;

    move-result-object v0

    iput-object v0, v1, Landroidx/preference/MultiSelectListPreference$SavedState;->T1:Ljava/util/Set;
...
.method protected J4(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/preference/Preference;->F1(Ljava/util/Set;)Ljava/util/Set;
...
.method public T8()[Ljava/lang/CharSequence;
    .locals 1

    iget-object v0, p0, Landroidx/preference/MultiSelectListPreference;->M2:[Ljava/lang/CharSequence;
...
.method public v9()Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
