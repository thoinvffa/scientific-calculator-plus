...
.method constructor <init>(Landroidx/media/MediaBrowserServiceCompat$n;Landroidx/media/MediaBrowserServiceCompat$o;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    iput-object p1, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->X1:Landroidx/media/MediaBrowserServiceCompat$n;

    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->T1:Landroidx/media/MediaBrowserServiceCompat$o;

    iput-object p3, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->U1:Ljava/lang/String;

    iput-object p4, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->V1:Landroid/os/Bundle;

    iput-object p5, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->W1:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    iget-object v0, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->T1:Landroidx/media/MediaBrowserServiceCompat$o;

    invoke-interface {v0}, Landroidx/media/MediaBrowserServiceCompat$o;->asBinder()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->X1:Landroidx/media/MediaBrowserServiceCompat$n;
    ...
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->U1:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->U1:Ljava/lang/String;

    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->V1:Landroid/os/Bundle;

    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->W1:Landroid/support/v4/os/ResultReceiver;
