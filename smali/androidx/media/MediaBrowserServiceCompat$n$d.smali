...
.method constructor <init>(Landroidx/media/MediaBrowserServiceCompat$n;Landroidx/media/MediaBrowserServiceCompat$o;Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    iput-object p1, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->W1:Landroidx/media/MediaBrowserServiceCompat$n;

    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->T1:Landroidx/media/MediaBrowserServiceCompat$o;

    iput-object p3, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->U1:Ljava/lang/String;

    iput-object p4, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->V1:Landroid/os/IBinder;
...
.method public run()V
    ...
    iget-object v0, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->T1:Landroidx/media/MediaBrowserServiceCompat$o;

    invoke-interface {v0}, Landroidx/media/MediaBrowserServiceCompat$o;->asBinder()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->W1:Landroidx/media/MediaBrowserServiceCompat$n;
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->U1:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->W1:Landroidx/media/MediaBrowserServiceCompat$n;

    iget-object v2, v2, Landroidx/media/MediaBrowserServiceCompat$n;->a:Landroidx/media/MediaBrowserServiceCompat;

    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->U1:Ljava/lang/String;

    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$n$d;->V1:Landroid/os/IBinder;
