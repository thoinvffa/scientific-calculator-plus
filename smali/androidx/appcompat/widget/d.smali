...
.method private a(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {v1}, Ld/h/k/v;->q(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Ld/h/k/v;->r(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p1, v0, v1}, Landroidx/appcompat/widget/f;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/c0;[I)V
...
.method b()V
    ...
    invoke-static {v0, v1, v2}, Landroidx/appcompat/widget/f;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/c0;[I)V
...
.method e(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v1, p2, v2}, Landroidx/appcompat/widget/e0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/e0;
    ...
    invoke-static/range {v1 .. v7}, Ld/h/k/v;->j0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/e0;->n(II)I
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/e0;->c(I)Landroid/content/res/ColorStateList;

    move-result-object v1

    invoke-static {p1, v1}, Ld/h/k/v;->p0(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, v1, p2}, Landroidx/appcompat/widget/e0;->k(II)I

    move-result p2

    const/4 v1, 0x0

    invoke-static {p2, v1}, Landroidx/appcompat/widget/p;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    invoke-static {p1, p2}, Ld/h/k/v;->q0(Landroid/view/View;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
