...
.method private a(Ljava/lang/String;Landroidx/appcompat/widget/v$d;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/v;->b:Ld/e/g;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/v;->b:Ld/e/g;
...
.method private declared-synchronized b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Ld/e/d;->j(JLjava/lang/Object;)V
    :try_end_0
...
.method private f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object v3, p0, Landroidx/appcompat/widget/v;->g:Landroidx/appcompat/widget/v$e;
    ...
    :cond_2
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/v$e;->c(Landroidx/appcompat/widget/v;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private declared-synchronized i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, Ld/e/d;->f(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Ld/e/d;->k(J)V
    :try_end_2
...
.method public static declared-synchronized l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/appcompat/widget/v$c;->j(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v2, p0, p1, v1}, Landroidx/appcompat/widget/v$c;->k(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/v;->c:Ld/e/h;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/v;->b:Ld/e/g;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/v;->c:Ld/e/h;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/v;->c:Ld/e/h;

    invoke-virtual {v8, p2, v3}, Ld/e/h;->b(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/v;->b:Ld/e/g;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/v;->c:Ld/e/h;
...
.method private v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, p1, p2, p4}, Landroidx/appcompat/widget/v$e;->e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method declared-synchronized m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/v$e;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method o(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/v$e;->b(I)Landroid/graphics/PorterDuff$Mode;
...
.method declared-synchronized t(Landroid/content/Context;Landroidx/appcompat/widget/j0;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/j0;->d(I)Landroid/graphics/drawable/Drawable;
...
.method x(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/appcompat/widget/v$e;->a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
