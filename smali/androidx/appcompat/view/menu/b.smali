...
.field protected U1:Landroid/content/Context;

.field protected V1:Landroidx/appcompat/view/menu/g;

.field protected W1:Landroid/view/LayoutInflater;

.field private X1:Landroidx/appcompat/view/menu/m$a;

.field private Y1:I

.field private Z1:I

.field protected a2:Landroidx/appcompat/view/menu/n;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->T1:Landroid/content/Context;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->W1:Landroid/view/LayoutInflater;

    iput p2, p0, Landroidx/appcompat/view/menu/b;->Y1:I

    iput p3, p0, Landroidx/appcompat/view/menu/b;->Z1:I
...
.method public a(Landroidx/appcompat/view/menu/g;Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->X1:Landroidx/appcompat/view/menu/m$a;
...
.method public b(Z)V
    ...
    invoke-virtual {p0, v4, v5}, Landroidx/appcompat/view/menu/b;->r(ILandroidx/appcompat/view/menu/i;)Z
    ...
    :goto_1
    invoke-virtual {p0, v5, v6, p1}, Landroidx/appcompat/view/menu/b;->o(Landroidx/appcompat/view/menu/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public f(Landroidx/appcompat/view/menu/m$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->X1:Landroidx/appcompat/view/menu/m$a;
...
.method public g(Landroid/content/Context;Landroidx/appcompat/view/menu/g;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->U1:Landroid/content/Context;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    iput-object p2, p0, Landroidx/appcompat/view/menu/b;->V1:Landroidx/appcompat/view/menu/g;
...
.method public getId()I
    ...
    iget v0, p0, Landroidx/appcompat/view/menu/b;->b2:I
...
.method public abstract k(Landroidx/appcompat/view/menu/i;Landroidx/appcompat/view/menu/n$a;)V
.end method

.method public l(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/n$a;
    .locals 3

    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->W1:Landroid/view/LayoutInflater;

    iget v1, p0, Landroidx/appcompat/view/menu/b;->Z1:I
...
.method public n()Landroidx/appcompat/view/menu/m$a;
    .locals 1
...
.method public o(Landroidx/appcompat/view/menu/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/view/menu/b;->k(Landroidx/appcompat/view/menu/i;Landroidx/appcompat/view/menu/n$a;)V
...
.method public p(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/n;
    ...
    iget v1, p0, Landroidx/appcompat/view/menu/b;->Y1:I
...
.method public q(I)V
    ...
    iput p1, p0, Landroidx/appcompat/view/menu/b;->b2:I

    return-void
.end method

.method public abstract r(ILandroidx/appcompat/view/menu/i;)Z
.end method
