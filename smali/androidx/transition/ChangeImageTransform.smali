...
.field private static final D2:Landroid/animation/TypeEvaluator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/ChangeImageTransform;->C2:[Ljava/lang/String;
    ...
    sput-object v0, Landroidx/transition/ChangeImageTransform;->D2:Landroid/animation/TypeEvaluator;
    ...
    sput-object v0, Landroidx/transition/ChangeImageTransform;->E2:Landroid/util/Property;
...
.method private m0(Landroidx/transition/y;)V
    ...
    invoke-static {v1}, Landroidx/transition/ChangeImageTransform;->o0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private p0(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    .locals 4

    sget-object v0, Landroidx/transition/ChangeImageTransform;->E2:Landroid/util/Property;

    new-instance v1, Landroidx/transition/x$a;

    invoke-direct {v1}, Landroidx/transition/x$a;-><init>()V
...
.method private q0(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    .locals 5

    sget-object v0, Landroidx/transition/ChangeImageTransform;->E2:Landroid/util/Property;

    sget-object v1, Landroidx/transition/ChangeImageTransform;->D2:Landroid/animation/TypeEvaluator;
...
.method public K()[Ljava/lang/String;
    ...
    sget-object v0, Landroidx/transition/ChangeImageTransform;->C2:[Ljava/lang/String;
...
.method public i(Landroidx/transition/y;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/ChangeImageTransform;->m0(Landroidx/transition/y;)V
...
.method public t(Landroid/view/ViewGroup;Landroidx/transition/y;Landroidx/transition/y;)Landroid/animation/Animator;
    ...
    :cond_8
    sget-object p3, Landroidx/transition/ChangeImageTransform;->E2:Landroid/util/Property;

    invoke-virtual {p3, p1, p2}, Landroid/util/Property;->set(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-direct {p0, p1, p2, v2}, Landroidx/transition/ChangeImageTransform;->p0(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    :cond_9
    :goto_1
    invoke-direct {p0, p1}, Landroidx/transition/ChangeImageTransform;->q0(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
