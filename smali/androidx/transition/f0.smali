...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    sput-object v4, Landroidx/transition/f0;->d:Ljava/lang/reflect/Method;
    ...
    :cond_0
    sget-object v0, Landroidx/transition/f0;->d:Ljava/lang/reflect/Method;
...
.method static b(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v0, Landroidx/transition/f0;->a:Landroid/animation/LayoutTransition;
    ...
    invoke-direct {v0}, Landroidx/transition/f0$a;-><init>()V

    sput-object v0, Landroidx/transition/f0;->a:Landroid/animation/LayoutTransition;
    ...
    invoke-static {p1}, Landroidx/transition/f0;->a(Landroid/animation/LayoutTransition;)V
    ...
    sget v0, Landroidx/transition/p;->transition_layout_save:I

    invoke-virtual {p0, v0, p1}, Landroid/view/ViewGroup;->setTag(ILjava/lang/Object;)V

    :cond_2
    sget-object p1, Landroidx/transition/f0;->a:Landroid/animation/LayoutTransition;
    ...
    sget-boolean p1, Landroidx/transition/f0;->c:Z
    ...
    sput-object p1, Landroidx/transition/f0;->b:Ljava/lang/reflect/Field;
    ...
    :goto_1
    sput-boolean v1, Landroidx/transition/f0;->c:Z

    :cond_4
    sget-object p1, Landroidx/transition/f0;->b:Ljava/lang/reflect/Field;
    ...
    :try_start_2
    sget-object v1, Landroidx/transition/f0;->b:Ljava/lang/reflect/Field;
    ...
    :cond_7
    sget p1, Landroidx/transition/p;->transition_layout_save:I
