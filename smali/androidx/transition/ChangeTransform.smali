...
.field private E2:Landroid/graphics/Matrix;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/ChangeTransform;->F2:[Ljava/lang/String;
    ...
    sput-object v0, Landroidx/transition/ChangeTransform;->G2:Landroid/util/Property;
    ...
    sput-object v0, Landroidx/transition/ChangeTransform;->H2:Landroid/util/Property;
    ...
    :cond_0
    sput-boolean v2, Landroidx/transition/ChangeTransform;->I2:Z
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Landroidx/transition/ChangeTransform;->C2:Z

    iput-boolean v0, p0, Landroidx/transition/ChangeTransform;->D2:Z

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Landroidx/transition/ChangeTransform;->E2:Landroid/graphics/Matrix;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Landroidx/transition/ChangeTransform;->E2:Landroid/graphics/Matrix;
    ...
    iput-boolean v1, p0, Landroidx/transition/ChangeTransform;->C2:Z

    const-string v1, "reparent"

    const/4 v2, 0x0

    invoke-static {p1, p2, v1, v2, v0}, Landroidx/core/content/d/g;->e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z

    move-result p2

    iput-boolean p2, p0, Landroidx/transition/ChangeTransform;->D2:Z
...
.method private m0(Landroidx/transition/y;)V
    ...
    iget-boolean v1, p0, Landroidx/transition/ChangeTransform;->D2:Z
...
.method private n0(Landroid/view/ViewGroup;Landroidx/transition/y;Landroidx/transition/y;)V
    .locals 3
    ...
    :goto_0
    iget-object v2, v1, Landroidx/transition/Transition;->k2:Landroidx/transition/TransitionSet;
    ...
    sget-boolean p1, Landroidx/transition/ChangeTransform;->I2:Z
...
.method private o0(Landroidx/transition/y;Landroidx/transition/y;Z)Landroid/animation/ObjectAnimator;
    .locals 12
    ...
    invoke-static {v5}, Landroidx/transition/ChangeTransform;->q0(Landroid/view/View;)V
    ...
    sget-object v1, Landroidx/transition/ChangeTransform;->G2:Landroid/util/Property;
    ...
    sget-object v0, Landroidx/transition/ChangeTransform;->H2:Landroid/util/Property;
...
.method private p0(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/Transition;->O(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p2}, Landroidx/transition/Transition;->O(Landroid/view/View;)Z
...
.method static q0(Landroid/view/View;)V
    ...
    invoke-static/range {v0 .. v8}, Landroidx/transition/ChangeTransform;->s0(Landroid/view/View;FFFFFFFF)V

    return-void
.end method

.method private r0(Landroidx/transition/y;Landroidx/transition/y;)V
    .locals 4
    ...
    iget-object p2, p0, Landroidx/transition/ChangeTransform;->E2:Landroid/graphics/Matrix;
...
.method static s0(Landroid/view/View;FFFFFFFF)V
    ...
    invoke-static {p0, p3}, Ld/h/k/v;->F0(Landroid/view/View;F)V
...
.method public K()[Ljava/lang/String;
    ...
    sget-object v0, Landroidx/transition/ChangeTransform;->F2:[Ljava/lang/String;
...
.method public i(Landroidx/transition/y;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/ChangeTransform;->m0(Landroidx/transition/y;)V
...
.method public l(Landroidx/transition/y;)V
    ...
    sget-boolean v0, Landroidx/transition/ChangeTransform;->I2:Z
...
.method public t(Landroid/view/ViewGroup;Landroidx/transition/y;Landroidx/transition/y;)Landroid/animation/Animator;
    ...
    iget-boolean v2, p0, Landroidx/transition/ChangeTransform;->D2:Z

    if-eqz v2, :cond_1

    invoke-direct {p0, v0, v1}, Landroidx/transition/ChangeTransform;->p0(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    invoke-direct {p0, p2, p3}, Landroidx/transition/ChangeTransform;->r0(Landroidx/transition/y;Landroidx/transition/y;)V

    :cond_4
    invoke-direct {p0, p2, p3, v1}, Landroidx/transition/ChangeTransform;->o0(Landroidx/transition/y;Landroidx/transition/y;Z)Landroid/animation/ObjectAnimator;
    ...
    iget-boolean v1, p0, Landroidx/transition/ChangeTransform;->C2:Z

    if-eqz v1, :cond_5

    invoke-direct {p0, p1, p2, p3}, Landroidx/transition/ChangeTransform;->n0(Landroid/view/ViewGroup;Landroidx/transition/y;Landroidx/transition/y;)V
