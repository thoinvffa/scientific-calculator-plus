...
.method constructor <init>(Landroid/content/Context;Landroidx/constraintlayout/widget/ConstraintLayout;I)V
    ...
    iput-object v0, p0, Landroidx/constraintlayout/widget/b;->g:Landroidx/constraintlayout/widget/d;
...
.method public c(Landroidx/constraintlayout/widget/d;)V
    ...
    iput-object p1, p0, Landroidx/constraintlayout/widget/b;->g:Landroidx/constraintlayout/widget/d;
...
.method public d(IFF)V
    ...
    iget-object p2, p0, Landroidx/constraintlayout/widget/b;->g:Landroidx/constraintlayout/widget/d;

    if-eqz p2, :cond_6

    invoke-virtual {p2, v1, p1}, Landroidx/constraintlayout/widget/d;->b(II)V

    :cond_6
    iget-object p2, p0, Landroidx/constraintlayout/widget/b;->a:Landroidx/constraintlayout/widget/ConstraintLayout;

    invoke-virtual {p3, p2}, Landroidx/constraintlayout/widget/c;->d(Landroidx/constraintlayout/widget/ConstraintLayout;)V

    iget-object p2, p0, Landroidx/constraintlayout/widget/b;->g:Landroidx/constraintlayout/widget/d;

    if-eqz p2, :cond_c

    invoke-virtual {p2, v1, p1}, Landroidx/constraintlayout/widget/d;->a(II)V
    ...
    invoke-virtual {p2, p1, v0}, Landroidx/constraintlayout/widget/d;->b(II)V

    :cond_b
    iget-object p2, p0, Landroidx/constraintlayout/widget/b;->a:Landroidx/constraintlayout/widget/ConstraintLayout;

    invoke-virtual {v3, p2}, Landroidx/constraintlayout/widget/c;->d(Landroidx/constraintlayout/widget/ConstraintLayout;)V

    iget-object p2, p0, Landroidx/constraintlayout/widget/b;->g:Landroidx/constraintlayout/widget/d;

    if-eqz p2, :cond_c

    invoke-virtual {p2, p1, v0}, Landroidx/constraintlayout/widget/d;->a(II)V
