...
.method public static g(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Ljava/util/HashMap;)V
    ...
    sget v7, Landroidx/constraintlayout/widget/f;->CustomAttribute_attributeName:I
    ...
    :cond_0
    sget v7, Landroidx/constraintlayout/widget/f;->CustomAttribute_customBoolean:I
    ...
    sget-object v4, Landroidx/constraintlayout/widget/a$b;->Y1:Landroidx/constraintlayout/widget/a$b;

    goto/16 :goto_5

    :cond_1
    sget v7, Landroidx/constraintlayout/widget/f;->CustomAttribute_customColorValue:I

    if-ne v6, v7, :cond_2

    sget-object v3, Landroidx/constraintlayout/widget/a$b;->V1:Landroidx/constraintlayout/widget/a$b;
    ...
    :cond_2
    sget v7, Landroidx/constraintlayout/widget/f;->CustomAttribute_customColorDrawableValue:I

    if-ne v6, v7, :cond_3

    sget-object v3, Landroidx/constraintlayout/widget/a$b;->W1:Landroidx/constraintlayout/widget/a$b;

    goto :goto_1

    :cond_3
    sget v7, Landroidx/constraintlayout/widget/f;->CustomAttribute_customPixelDimension:I

    const/4 v9, 0x0

    if-ne v6, v7, :cond_4

    sget-object v3, Landroidx/constraintlayout/widget/a$b;->Z1:Landroidx/constraintlayout/widget/a$b;
    ...
    :cond_4
    sget v7, Landroidx/constraintlayout/widget/f;->CustomAttribute_customDimension:I
    ...
    :cond_5
    sget v7, Landroidx/constraintlayout/widget/f;->CustomAttribute_customFloatValue:I
    ...
    :cond_6
    sget v7, Landroidx/constraintlayout/widget/f;->CustomAttribute_customIntegerValue:I

    if-ne v6, v7, :cond_7

    sget-object v3, Landroidx/constraintlayout/widget/a$b;->T1:Landroidx/constraintlayout/widget/a$b;
    ...
    :cond_7
    sget v7, Landroidx/constraintlayout/widget/f;->CustomAttribute_customStringValue:I

    if-ne v6, v7, :cond_8

    sget-object v3, Landroidx/constraintlayout/widget/a$b;->X1:Landroidx/constraintlayout/widget/a$b;
