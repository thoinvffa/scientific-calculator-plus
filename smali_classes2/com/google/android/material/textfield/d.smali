...
.method private D(Landroid/widget/AutoCompleteTextView;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->m:Lf/c/b/c/w/h;
...
.method private u(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Lf/c/b/c/w/h;

    move-result-object v1

    sget v2, Lf/c/b/c/b;->colorControlHighlight:I

    invoke-static {p1, v2}, Lf/c/b/c/o/a;->d(Landroid/view/View;I)I
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILf/c/b/c/w/h;)V
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->v(Landroid/widget/AutoCompleteTextView;I[[ILf/c/b/c/w/h;)V
...
.method private v(Landroid/widget/AutoCompleteTextView;I[[ILf/c/b/c/w/h;)V
    .locals 5
    ...
    invoke-static {p2, v0, v1}, Lf/c/b/c/o/a;->g(IIF)I
    ...
    invoke-direct {v0, v4}, Lf/c/b/c/w/h;-><init>(Lf/c/b/c/w/m;)V

    new-instance v4, Landroid/content/res/ColorStateList;

    invoke-direct {v4, p3, v2}, Landroid/content/res/ColorStateList;-><init>([[I[I)V

    invoke-virtual {v0, v4}, Lf/c/b/c/w/h;->Y(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1}, Ld/h/k/v;->E(Landroid/view/View;)I
    ...
    invoke-static {p1}, Ld/h/k/v;->D(Landroid/view/View;)I
    ...
    invoke-static {p1, p2}, Ld/h/k/v;->o0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    invoke-static {p1, p3, p4, v0, v1}, Ld/h/k/v;->A0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private w(Landroid/widget/AutoCompleteTextView;I[[ILf/c/b/c/w/h;)V
    .locals 7

    sget v0, Lf/c/b/c/b;->colorSurface:I

    invoke-static {p1, v0}, Lf/c/b/c/o/a;->d(Landroid/view/View;I)I
    ...
    invoke-static {p2, v0, v2}, Lf/c/b/c/o/a;->g(IIF)I
    ...
    invoke-virtual {v1, v6}, Lf/c/b/c/w/h;->Y(Landroid/content/res/ColorStateList;)V

    sget-boolean v3, Lcom/google/android/material/textfield/d;->q:Z

    if-eqz v3, :cond_0

    invoke-virtual {v1, v0}, Lf/c/b/c/w/h;->setTint(I)V
    ...
    invoke-direct {p3, v0}, Lf/c/b/c/w/h;-><init>(Lf/c/b/c/w/m;)V

    const/4 v0, -0x1

    invoke-virtual {p3, v0}, Lf/c/b/c/w/h;->setTint(I)V
...
.method private z(FFFI)Lf/c/b/c/w/h;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lf/c/b/c/w/m$b;->I(F)Lf/c/b/c/w/m$b;

    invoke-virtual {v0, p2}, Lf/c/b/c/w/m$b;->v(F)Lf/c/b/c/w/m$b;

    invoke-virtual {v0, p2}, Lf/c/b/c/w/m$b;->z(F)Lf/c/b/c/w/m$b;
    ...
    invoke-static {p2, p3}, Lf/c/b/c/w/h;->m(Landroid/content/Context;F)Lf/c/b/c/w/h;

    move-result-object p2

    invoke-virtual {p2, p1}, Lf/c/b/c/w/h;->setShapeAppearanceModel(Lf/c/b/c/w/m;)V

    const/4 p1, 0x0

    invoke-virtual {p2, p1, p4, p1, p4}, Lf/c/b/c/w/h;->a0(IIII)V
...
.method a()V
    ...
    sget v1, Lf/c/b/c/d;->mtrl_shape_corner_size_small_component:I
    ...
    sget v2, Lf/c/b/c/d;->mtrl_exposed_dropdown_menu_popup_elevation:I
    ...
    sget v3, Lf/c/b/c/d;->mtrl_exposed_dropdown_menu_popup_vertical_padding:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelOffset(I)I

    move-result v2

    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->z(FFFI)Lf/c/b/c/w/h;

    move-result-object v3

    const/4 v4, 0x0

    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->z(FFFI)Lf/c/b/c/w/h;

    move-result-object v0

    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:Lf/c/b/c/w/h;
    ...
    sget v0, Lf/c/b/c/e;->mtrl_dropdown_arrow:I

    goto :goto_0

    :cond_0
    sget v0, Lf/c/b/c/e;->mtrl_ic_arrow_drop_down:I
    ...
    sget v2, Lf/c/b/c/j;->exposed_dropdown_menu_content_description:I
