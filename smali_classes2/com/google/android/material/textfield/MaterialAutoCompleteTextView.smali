...
# instance fields
.field private final W1:Landroidx/appcompat/widget/ListPopupWindow;

.field private final X1:Landroid/view/accessibility/AccessibilityManager;

.field private final Y1:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lf/c/b/c/b;->autoCompleteTextViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->Y1:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getContext()Landroid/content/Context;

    move-result-object p1

    sget-object v3, Lf/c/b/c/l;->MaterialAutoCompleteTextView:[I

    sget v5, Lf/c/b/c/k;->Widget_AppCompat_AutoCompleteTextView:I
    ...
    sget p3, Lf/c/b/c/l;->MaterialAutoCompleteTextView_android_inputType:I
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->X1:Landroid/view/accessibility/AccessibilityManager;
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->W1:Landroidx/appcompat/widget/ListPopupWindow;

    const/4 p1, 0x1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/ListPopupWindow;->G(Z)V

    iget-object p1, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->W1:Landroidx/appcompat/widget/ListPopupWindow;

    invoke-virtual {p1, p0}, Landroidx/appcompat/widget/ListPopupWindow;->A(Landroid/view/View;)V

    iget-object p1, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->W1:Landroidx/appcompat/widget/ListPopupWindow;

    const/4 p3, 0x2

    invoke-virtual {p1, p3}, Landroidx/appcompat/widget/ListPopupWindow;->F(I)V
    ...
    invoke-virtual {p1, p3}, Landroidx/appcompat/widget/ListPopupWindow;->m(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p1, p3}, Landroidx/appcompat/widget/ListPopupWindow;->I(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method static synthetic a(Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;)Landroidx/appcompat/widget/ListPopupWindow;
    ...
    iget-object p0, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->W1:Landroidx/appcompat/widget/ListPopupWindow;
...
.method private d()I
    ...
    iget-object v5, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->W1:Landroidx/appcompat/widget/ListPopupWindow;

    invoke-virtual {v5}, Landroidx/appcompat/widget/ListPopupWindow;->u()I
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->W1:Landroidx/appcompat/widget/ListPopupWindow;
    ...
    iget-object v2, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->Y1:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->Y1:Landroid/graphics/Rect;
...
.method public showDropDown()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->X1:Landroid/view/accessibility/AccessibilityManager;
